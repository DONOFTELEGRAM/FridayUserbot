...
if PMPERMIT_PIC is None:
    WARN_PIC = "https://telegra.ph/file/fdd0297919732583732f4.jpg"
else:
...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Protection By 📅🔥 Vill𐌀iႶ™❬❬ઝ¡ทg_૨¡ρ⛦❭❭"
)
...
USER_BOT_NO_WARN = (
    "**Hello, This is 📅🔥 Vill𐌀iႶ™❬❬ઝ¡ทg_૨¡ρ⛦❭❭ PM Protection Service ⚠️**\n\n"
...
@bot.on(events.NewMessage(incoming=True, from_users=(1421858077)))
